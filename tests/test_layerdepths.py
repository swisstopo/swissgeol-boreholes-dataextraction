...
def test_line_anchor():  # noqa: D103
    ...
    start = LayerDepthsEntry(Decimal(5), pymupdf.Rect(0, 0, 1, 1), 0)
    end = LayerDepthsEntry(Decimal(10), pymupdf.Rect(0, 2, 1, 3), 0)
    ...
    left = LayerDepthsEntry(Decimal(5), pymupdf.Rect(0, 0, 1, 1), 0)
    right = LayerDepthsEntry(Decimal(10), pymupdf.Rect(2, 0, 3, 1), 0)
    ...
    end_next_page = LayerDepthsEntry(Decimal(10), pymupdf.Rect(0, 0, 1, 1), 1)
...
def test_background_rect():  # noqa: D103
    ...
    start = LayerDepthsEntry(Decimal(5), rect, 0)
    end = LayerDepthsEntry(Decimal(10), rect, 0)
    ...
    start = LayerDepthsEntry(Decimal(5), pymupdf.Rect(0, 1, 1, 2), 0)
    end = LayerDepthsEntry(Decimal(10), pymupdf.Rect(0, 0.5, 1, 1), 1)
    depths = LayerDepths(start, end)
