...
from swissgeol_doc_processing.utils.file_utils import find_project_root, read_params
...
doc_with_digits_in_coordinates = pymupdf.open(find_project_root() / "example" / "A7367.pdf")
