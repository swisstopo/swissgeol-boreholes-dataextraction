...
textline1 = TextLine([DepthInterval(fitz.Rect([0, 0, 10, 10]), "Hello")])
textline2 = TextLine([DepthInterval(fitz.Rect([0, 15, 10, 25]), "World")])
textline3 = TextLine([DepthInterval(fitz.Rect([0, 37, 10, 47]), "Hey")])  # larger vertical distance to previous blocks
