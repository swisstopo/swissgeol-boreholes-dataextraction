...
from stratigraphy.util.find_depth_columns import depth_column_entries, find_depth_columns
...
def test_find_depth_columns():  # noqa: D103
    ...
    assert len(columns[0].entries) == 5, "The column should have 4 entries"
