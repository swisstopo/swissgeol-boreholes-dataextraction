...
class MetadataEvaluator:
    ...
    def __init__(self, metadata: BoreholeMetadata, ground_truth_path: str):
        ...
        self.metadata_ground_truth = (
            GroundTruth(ground_truth_path).for_file(self.metadata.filename).get("metadata", {})
        )
    ...
    def evaluate(self) -> FileBoreholeMetadataMetrics:
        ...
        ground_truth_coordinates = self.metadata_ground_truth.get("coordinates")
        ...
        ground_truth_elevation = self.metadata_ground_truth.get("reference_elevation")
