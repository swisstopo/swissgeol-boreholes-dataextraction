...
import pymupdf
import rtree
from extraction.extraction.stratigraphy.interval.interval import AAboveBInterval, Interval, IntervalBlockPair
from extraction.extraction.stratigraphy.layer.layer import (
    ExtractedBorehole,
    Layer,
    LayerDepths,
)
from extraction.extraction.stratigraphy.layer.page_bounding_boxes import (
    MaterialDescriptionRectWithSidebar,
    PageBoundingBoxes,
)
from extraction.extraction.stratigraphy.sidebar.classes.sidebar import (
    Sidebar,
    SidebarNoise,
    noise_count,
)
...
from extraction.extraction.stratigraphy.sidebar.extractor.layer_identifier_sidebar_extractor import (
...
from extraction.extraction.utils.geometry.util import x_overlap, x_overlap_significant_smallest
from extraction.extraction.utils.text.find_description import (
    get_description_blocks,
    get_description_lines,
)
from extraction.extraction.utils.text.textblock import (
    MaterialDescription,
