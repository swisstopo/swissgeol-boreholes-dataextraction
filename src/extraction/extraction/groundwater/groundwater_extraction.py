...
import numpy as np
import pymupdf
from extraction.extraction.groundwater.utility import extract_date, extract_depth, extract_elevation
from extraction.extraction.utils.data_extractor import (
    DataExtractor,
    ExtractedFeature,
    FeatureOnPage,
)
...
class GroundwaterLevelExtractor(DataExtractor):
    ...
    def extract_groundwater(
        ...
        if not found_groundwater and self.is_searching_groundwater_illustration:
            from extraction.extraction.groundwater.gw_illustration_template_matching import (
