...
from extraction.extraction.groundwater.groundwater_extraction import GroundwatersInBorehole
from extraction.extraction.metadata.metadata import BoreholeMetadata
from extraction.extraction.stratigraphy.layer.layer import LayersInBorehole
