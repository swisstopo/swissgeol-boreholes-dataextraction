...
import pymupdf
from extraction.extraction.metadata.coordinate_extraction import Coordinate, CoordinateExtractor
from extraction.extraction.metadata.elevation_extraction import Elevation, ElevationExtractor
