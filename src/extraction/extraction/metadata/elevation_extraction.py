...
import numpy as np
import pymupdf
from extraction.extraction.groundwater.utility import extract_elevation
from extraction.extraction.utils.data_extractor import (
    DataExtractor,
    ExtractedFeature,
    FeatureOnPage,
)
from extraction.extraction.utils.text.extract_text import extract_text_lines_from_bbox
