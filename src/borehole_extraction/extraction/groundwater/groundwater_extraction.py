...
import numpy as np
import pymupdf
from borehole_extraction.extraction.groundwater.utility import extract_date, extract_depth, extract_elevation
...
class GroundwaterLevelExtractor(DataExtractor):
    ...
    def extract_groundwater(
        ...
        if not found_groundwater and self.is_searching_groundwater_illustration:
            from borehole_extraction.extraction.groundwater.gw_illustration_template_matching import (
