...
from borehole_extraction.evaluation.evaluation_dataclasses import (
    FileBoreholeMetadataMetrics,
    Metrics,
    OverallBoreholeMetadataMetrics,
)
from borehole_extraction.evaluation.utility import evaluate_single
from borehole_extraction.extraction.metadata.coordinate_extraction import Coordinate
from borehole_extraction.extraction.predictions.borehole_predictions import FileMetadataWithGroundTruth
