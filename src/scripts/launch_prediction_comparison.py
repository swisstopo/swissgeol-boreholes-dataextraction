...
Run locally with, e.g.:
    WANDB_ENTITY=... WANDB_PROJECT=... python src/scripts/launch_prediction_comparison.py
...
from scripts.wandb_prediction_comparison import build_comparison_table, load_table
